...
@Composable
fun GbSkinSelectionScreen(
    skinManager: GbSkinManager,
    onSkinSelected: (String) -> Unit,
    modifier: Modifier = Modifier,
) {
    val selectedSkin = skinManager.getSelectedSkinFlow().collectAsState(GameBoySkin.GREY)
    val allSkins = skinManager.getAllSkins()
    var selectedModelFilter by remember { mutableStateOf<GameBoyModel?>(null) }
    ...
    Column(
        ...
        Row(
            ...
            GameBoyModel.entries.forEach { model ->
                FilterChip(
